...
module pipeline_cpu_top(
    ...
    assign pred_taken_f = btb_hit_f && pht_predict_taken_f;
    assign predicted_next_pc_f = pred_taken_f ? btb_target_f : pc4_f;
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            if (!stall) begin
                ...
                pred_target_fetch_q <= btb_target_f;
                fetch_valid_q <= 1'b1;
            end
