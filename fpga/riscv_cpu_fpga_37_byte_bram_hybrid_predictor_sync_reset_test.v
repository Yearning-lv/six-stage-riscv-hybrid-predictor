...
module pht(
    ...
    wire [3:0] query_index = query_pc[5:2];
    wire [3:0] update_index = update_pc[5:2];
...
module hybrid_selector(
    ...
    assign query_index = query_pc[5:2];
...
module pipeline_cpu_top(
    ...
    reg  [3:0]  selector_index_fetch_q;
    reg         fetch_valid_q;
    reg         fetch_flush_q;
    reg         stall_q;
    ...
    reg  [3:0]  stall_selector_index_q;
    reg         stall_valid_q;
